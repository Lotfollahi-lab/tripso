...
This script trains both the Base and Global models on the tokenized MNC dataset.
...
Inputs:
    ...
    - data/processed/mnc_genes.h5ad: MNC raw gene expression data (for Global model)
...
data_dir = '/lustre/scratch126/cellgen/lotfollahi/mm58/gplearner_reproducibility/06_tutorial_MNC/data/processed/input_dataset'
...
gplearner.train(
    ...
    adata_path = os.path.join(root_dir, 'data/processed/input_h5ad/mnc_gp_genes.h5ad'),
