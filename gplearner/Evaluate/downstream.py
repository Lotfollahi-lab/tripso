...
class gpEval:
    ...
    def generate_attention_matrix(
        ...
        if (gp_for_downstream != 'cell_token') and (gp_for_downstream not in self.gp_inputs):
            raise ValueError(f'{gp_for_downstream} must be one of "cell_token" or {self.gp_inputs}')
